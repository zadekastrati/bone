...
@section('content')
    <div class="mx-auto max-w-md">
        <div class="text-center">
            <h1 class="font-display text-2xl font-bold text-ink-950 sm:text-3xl">Reset your password</h1>
            <p class="text-muted mt-2">Enter your account email and we'll send you a 6-digit code to reset your password.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.reset.send') }}" class="panel mt-8 space-y-5">
            ...
            <button type="submit" class="btn-primary w-full py-3">Send code</button>
        </form>
