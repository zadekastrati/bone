    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:12px;padding:32px;box-shadow:0 1px 3px rgba(62,52,44,0.08);">
        <tr>
            <td>
                ...
                <p style="margin:0 0 24px;">{!! __('Use this code to :action:', ['action' => '<strong>'.__('reset your :app password', ['app' => e($appName)]).'</strong>']) !!}</p>
                ...
                <p style="margin:0 0 16px;font-size:14px;color:#73655a;">{{ __('This code expires in 15 minutes. If you did not request a password reset, you can ignore this email.') }}</p>
