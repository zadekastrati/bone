    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:12px;padding:32px;box-shadow:0 1px 3px rgba(62,52,44,0.08);">
        <tr>
            <td>
                ...
                <p style="margin:0 0 24px;">Use this code to confirm adding <strong>{{ $newPhone }}</strong> as the phone number on your {{ $appName }} account:</p>
                ...
                <p style="margin:0 0 16px;font-size:14px;color:#73655a;">This code expires in 15 minutes. If you didn't request this, you can ignore this email — your phone number won't change.</p>
