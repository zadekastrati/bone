...
>
    ...
    >
        ...
        <div class="shrink-0 border-b border-zinc-200/80 bg-gradient-to-b from-zinc-50 to-white">
            ...
            {{-- Media slider --}}
            <div class="px-6 pt-2">
                <div class="group relative h-28 w-full overflow-hidden rounded-xl border border-zinc-200/80 bg-white shadow-soft">
                    <div
        ...
        <div class="flex-1 overflow-y-auto px-6 py-6 space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <x-admin.badge x-show="selectedProduct?.is_active" tone="success">Active</x-admin.badge>
                <x-admin.badge x-show="!selectedProduct?.is_active" tone="neutral">Inactive</x-admin.badge>
            </div>
        ...
        <div class="flex shrink-0 gap-3 border-t border-zinc-200/80 bg-zinc-50/60 px-6 py-4">
            <a
                :href="selectedProduct ? `{{ url('admin/products') }}/${selectedProduct.slug}/edit` : '#'"
                class="btn-primary flex-1"
            >
                <x-icons.pencil-square class="h-4 w-4" />
                Edit Product
            </a>
            <button @click="detailModal = false" class="btn-secondary">Close</button>
        </div>
    </div>
</div>
