...
<body
    ...
    <div class="admin-layout" x-data="{ sidebarOpen: false }" @keydown.window.escape="sidebarOpen = false">
        ...
        <aside class="admin-layout__sidebar" :class="{ 'is-open': sidebarOpen }">
            ...
            'label' => 'Sales',
            'items' => [
            ['route' => 'admin.orders.index', 'match' => ['admin.orders.index', 'admin.orders.show', 'admin.orders.update',
            'admin.orders.destroy'], 'label' => 'Orders', 'path' => 'M15.75
